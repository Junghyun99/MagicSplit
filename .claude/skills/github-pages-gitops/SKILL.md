...
[브라우저 GitHub Pages]
  ...
  │
[GitHub 저장소]
  └─ GitHub Actions cron (trading-bot.yml)
...
| 저장 성공인데 봇이 새 값 미사용 | GitHub Actions가 이전 checkout 사용 | `trading-bot.yml`의 cron 대기 (최대 1시간). 또는 GitHub UI에서 `workflow_dispatch` 수동 트리거 |
